        ...
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="#">Central Hospitals</a><button data-toggle="collapse" class="navbar-toggler navbar-toggler-right" data-target="#navbarResponsive" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation" value="Menu"><i class="fa fa-bars"></i></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item nav-link js-scroll-trigger"><a class="nav-link js-scroll-trigger" data-bss-hover-animate="pulse" href="../appointments/appointments.html">Appointments</a></li>
        ...
        <div class="col" style="margin-top: 20px;">
            <div class="row" style="margin-top: 25px;margin-bottom: 20px;">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-2" style="color: rgb(129,129,129);border-color: rgb(0,0,0);">Prescription ID:&nbsp;</h6>
                            <h4 class="text-capitalize card-title" style="color: rgb(0,0,0);font-size: 20px;">Dr. nkajscn kdjcn</h4>
                            <h6 class="mb-2" style="color: rgb(27,27,27);border-color: rgb(0,0,0);">Date</h6>
                            <p class="card-text" style="color: rgb(0,0,0);">Nullam id dolor id <br>nibh ultricies vehicula <br>ut id elit. Cras justo odio, <br>dapibus ac facilisis in, <br>egestas eget quam. <br>Donec id elit non mi <br>porta gravida at.<br></p>
                            <div class="row">

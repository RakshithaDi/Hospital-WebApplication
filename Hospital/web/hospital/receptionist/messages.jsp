    ...
    <nav class="navbar navbar-light navbar-expand-md d-flex d-xl-flex align-items-center align-content-center align-self-center mx-auto justify-content-xl-center align-items-xl-center navigation-clean-search" style="background: rgb(255,255,255);">
        <div class="container"><a class="navbar-brand" href="#"><i class="fas fa-hospital" style="font-size: 25px;"></i></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link" data-bss-hover-animate="pulse" href="messages.jsp"><strong>CHAT</strong></a></li>
            ...
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="card" style="background: rgb(255,255,255);">
                            <div class="card-body" style="height: 700px;">
                                <div class="col" style="padding-right: 0px;padding-left: 0px;">
                                    <div class="row" style="margin-right: 0px;margin-bottom: 10px;border-style: none;">
                                        <div class="col" style="padding-right: 5px;padding-left: 5px;border-style: none;"><button class="btn btn-dark btn-block text-capitalize text-left border rounded border-light" type="button" style="height: 60px;color: rgb(255,255,255);border-width: 0px;"><span class="text-left" style="color: rgb(255,255,255);border-style: none;"><i class="fa fa-user-circle" style="font-size: 18px;"></i></span><span class="text-left" style="color: rgb(255,255,255);border-style: none;margin-left: 8px;font-family: Cabin, sans-serif;">Hasiru Navodya</span></button></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-8" style="padding-left: 0px;">
                            ...
                            <div class="col">
                                <div class="card" style="height: 650px;">
                                    <div class="card-body" style="padding: 10px;">
                                        <div class="col d-xl-flex justify-content-xl-center align-items-xl-center" style="padding-right: 0px;padding-left: 0px;height: 52px;margin-bottom: 10px;background: #e0e0e0;border-radius: 5px;font-family: Cabin, sans-serif;"><span class="text-center" style="color: rgb(0,0,0);font-family: Cabin, sans-serif;font-size: 21px;">Hasiru Navodya</span></div>
                                        <div class="col" style="height: 565px;border-radius: 5px;border: 1px solid rgb(221,221,221);padding-right: 20px;padding-left: 20px;">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group text-center d-xl-flex justify-content-xl-center align-items-xl-center" style="padding: 12px;"><input class="border rounded" type="text" style="width: 559px;height: 40px;margin-right: 12px;font-family: Cabin, sans-serif;"><button class="btn btn-light" type="button" style="border-radius: 3px;font-family: Cabin, sans-serif;">SEND&nbsp;<i class="fa fa-send-o"></i></button></div>
                            </div>
                        </div>
                    </div>
                </div>
